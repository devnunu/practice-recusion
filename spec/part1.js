...
(function() {
  ...
  describe('Exercises in Recursion in Recursion in Recursion in...', function() {
    ...
    describe('14. Compare Strings', function() {
    ...
    describe('15. Create array from string', function() {
    ...
    describe('16. Reverse an array', function() {
    ...
    describe('17. Build an array with a given value and length', function() {
    ...
    describe('18. Count value in array', function() {
    ...
    describe('19. Recursive Map', function() {
      var timesTwo, input;
    ...
    describe('20. Count key in object', function() {
    ...
    describe('21. Count value in object', function() {
      var input = {'e': {'x':'y'}, 't':{'r': {'e':'r'}, 'p': {'y':'r'}},'y':'e'};
    ...
    describe('22. Replace keys in object', function() {
    ...
    describe('23. First n Fibonacci', function() {
    ...
    describe('24. Return nth Fibonacci', function() {
    ...
    describe('25. Flatten nested arrays', function() {
